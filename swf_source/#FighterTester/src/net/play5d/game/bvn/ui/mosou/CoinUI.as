package net.play5d.game.bvn.ui.mosou {
	...
	public class CoinUI {
		...
		private function addMoneyBack(money:int):void {
			GameUI.alert(
				GetLangText("game_ui.alert.musou_add_money.title"),
				GetLangText("game_ui.alert.musou_add_money.message_prefix") + money +
					GetLangText("game_ui.alert.musou_add_money.message_suffix")
			);

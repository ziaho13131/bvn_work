...
package net.play5d.game.bvn.ctrl.game_ctrls {
	...
	public class GameStartCtrl {
		...
		public function start3v3(p1:FighterMain, p2:FighterMain,p1_1:FighterMain,p1_2:FighterMain,p2_1:FighterMain,p2_2:FighterMain,introTeamId:int = -1):void {
			_p1 = p1;
			_p2 = p2;
			_p1_1 = p1_1;
			_p1_2 = p1_2;
		...
		private function renderStart3v3():Boolean {
			if (_uiPlaying) {
				return false;
			}
			if (_p1.actionState == FighterActionState.KAI_CHANG || _p2.actionState == FighterActionState.KAI_CHANG) 
